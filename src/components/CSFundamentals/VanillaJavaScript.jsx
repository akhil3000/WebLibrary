...
const VanillaJavaScript = () => {
  return (
    ...
    <MenuTitle title="JavaScript Module from Angela You Course" url="https://www.udemy.com/course/the-complete-web-development-bootcamp/"/>
    <MenuTitle title="JavaScript Documentation" url="https://www.w3schools.com/js/"/>
    ...
    <MenuTitle title="Namaste JavaScript Season1" url="https://www.youtube.com/playlist?list=PLlasXeu85E9cQ32gLCvAvr9vNaUccPVNP"/>
